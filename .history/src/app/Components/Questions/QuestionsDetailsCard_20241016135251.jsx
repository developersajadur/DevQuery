                  ...
                  <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
                    ...
                    <div className="flex items-center gap-5">
                      <button
                        ...
                        {answer.liked ? <AiOutlineLike className="mr-1" /> : <AiOutlineLike className="mr-1" />}
                        <span className="font-semibold">{answer.likes} Like</span>
                      </button>
                      ...
                      <button
                        ...
                        {answer.unliked ? <AiOutlineDislike className="mr-1" /> : <AiOutlineDislike className="mr-1" />}
                        <span className="font-semibold">{answer.unlikes} Dislike</span>
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="mt-4">
                    <form onSubmit={(e) => handleCommentSubmit(e, answer._id)}>
                      ...
                      <div className='flex items-center justify-between px-2 my-3'>
                        ...
                        >
                          <p className='underline text-blue-500'>All comments</p>
                        </Link>
                      </div>
                    </form>
                  </div>
