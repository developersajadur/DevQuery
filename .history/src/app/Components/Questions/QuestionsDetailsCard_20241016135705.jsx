  ...
  return (
    <div>
      ...
      <div className="mb-6">
        ...
        {answers.length > 0 ? (
          answers.map((answer) => (
            <Card className="mb-4 p-6 py-8 w-full bg-white border-b border-gray-300 rounded-lg" key={answer._id}>
              <div className="flex items-start">
                <Avatar
                ...
                />
                <div className="ml-4 w-full">
                  <h4 className="font-medium text-blue-500">{answer.user}</h4>
                  <p className="text-gray-700 mt-1 mb-2">{answer.answer}</p>
                  <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
                    ...
                    <div className="flex items-center gap-5">
                      <button
                        ...
                        className={`text-white bg-gradient-to-r from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-2
                          ${answer.liked ? 'opacity-100' : 'hover:opacity-80'}`}>
                        <AiOutlineLike className="mr-1" /> {answer.likes} Like
                      </button>
                      ...
                      <button
                        ...
                        className={`text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-2
                          ${answer.unliked ? 'opacity-100' : 'hover:opacity-80'}`}>
                        <AiOutlineDislike className="mr-1" /> {answer.unlikes} Dislike
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="mt-4">
                    <form onSubmit={(e) => handleCommentSubmit(e, answer._id)}>
                      ...
                      <div className='flex items-center justify-between px-2 my-3'>
                        <button type="submit" className="text-white bg-gradient-to-r from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-2">
                          Submit Comment
                        </button>
                        <Link
                          href={{ pathname: `/allcomments/${answer._id}`, query: { ref: url } }}
                        >
                          <button className="text-gray-900 bg-gradient-to-r from-teal-200 to-lime-200 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-lime-200 dark:focus:ring-teal-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-2">
                            All Comments
                          </button>
                        </Link>
                      </div>
