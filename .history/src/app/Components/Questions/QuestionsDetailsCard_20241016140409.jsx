      ...
      >
        <div className="flex items-start">
          ...
          <div className="ml-5 w-full">
            ...
            <p className="text-gray-700 mt-2 mb-4 text-base">{answer.answer}</p>
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
              ...
              <div className="flex items-center gap-3 mt-3 md:mt-0">
                ...
                <button
                  ...
                  className={`flex items-center text-white bg-gradient-to-r from-red-500 to-pink-400 hover:opacity-80 focus:ring-4 focus:ring-pink-300 rounded-full px-4 py-2 text-sm transition-opacity
