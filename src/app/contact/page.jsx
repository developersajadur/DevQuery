          ...
          <form onSubmit={buttonForSubmit}>
            <div className='grid grid-cols-2 gap-5'>
              ...
              <div>
                ...
                <input type="text" name='name' value={formData.name} onChange={handleChange} required placeholder='Enter your name' className='w-full h-9 px-9 border-gray-200 rounded-sm border-[1px]' />
              </div>
              ...
              <div>
                ...
                <input type="email" name='email' value={formData.email} onChange={handleChange} required placeholder='Enter email' className='w-full h-9 px-9 border-gray-200 rounded-sm border-[1px]' />
              </div>
              ...
              <div>
                ...
                <input type="text" name='subject' value={formData.subject} onChange={handleChange} required placeholder='Enter subject' className='w-full h-9 px-9 border-gray-200 rounded-sm border-[1px]' />
              </div>
            ...
            <div className='mt-4'>
              ...
              <textarea name='message' value={formData.message} onChange={handleChange} placeholder='Write the message' required rows="6" cols="88" className='w-full' />
            </div>
