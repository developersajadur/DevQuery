...
export const GET = async (req) => {
  ...
  const userEmail = searchParams.get("userEmail"); // Expecting recipient's email
  const participantEmail = searchParams.get("participantEmail"); // Expecting sender's email
  ...
  try {
    ...
    // Find the participant data based on userEmail and participantsId
